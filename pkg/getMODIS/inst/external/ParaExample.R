...
startdate <- "2009.01.01"  ## start-date YYYY.MM.DD, limit periode to be downloaded/processed
enddate   <- "2009.01.05"   ## end-date YYYY.MM.DD,limit periode to be downloaded/processed
...
# extract SDS
SDSstring <- "11100000000" # run: getSDS(HdfName="name.hdf") to create the string 
